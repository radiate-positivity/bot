...
def get_contact_keyboard() -> InlineKeyboardBuilder:
    ...
    if PR_SPECIALIST_PHONE and PR_SPECIALIST_PHONE != "+1234567890":
        builder.row(
            InlineKeyboardButton(
                text="📞 Позвонить",
                url=f"tel:{PR_SPECIALIST_PHONE}"
            )
        )
...
"""
    ...
    if PR_SPECIALIST_PHONE and PR_SPECIALIST_PHONE != "+1234567890":
        contacts.append(f"• <b>Телефон:</b> {PR_SPECIALIST_PHONE}")
...
1. <b>Первичная консультация</b> (30 мин) - бесплатно
   • Общая оценка ситуации
   • Рекомендации по стратегии
   
2. <b>Детальная консультация</b> (60 мин) - $150
   • Подробный разбор документов
   • Стратегия подготовки пакета
   • Ответы на все вопросы

<b>Для записи:</b>
1. Выберите удобное время (Пн-Пт, 9:00-18:00 EST)
2. Отправьте запрос через Telegram, email или телефон
